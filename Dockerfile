...
# This includes egg installing the srt_file_translator package
COPY srt_file_translator/__init__.py /app/srt_file_translator/__init__.py
COPY pyproject.toml /app/pyproject.toml
RUN pip install -e .

COPY ./util_test_helper.sh /app/util_test_helper.sh
COPY ./test/test_01.py /app/test/test_01.py
